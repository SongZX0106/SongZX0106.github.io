...
![](https://szx-bucket1.fsh.bcebos.com/react/react-redux模型图.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/21.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/22.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/23.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/24.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/25.png)

### 配置打包目录

默认打包出来我们需要吧打包文件放在服务器的根目录下使用，但是有时候我们需要吧文件放在二级目录下。这时我们需要修改 `package.json` 文件

![](https://szx-bucket1.fsh.bcebos.com/react/26.png)
...
![](https://szx-bucket1.fsh.bcebos.com/react/14.gif)
...
![](https://szx-bucket1.fsh.bcebos.com/react/27.png)
